            ...
            <section className='Detais'>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <div className="card">
                                    <img className='card-img-top p-1' src={ProductDetails?.image} alt="..." />
                ...
                <div className="d-flex justify-content-center ">
                    <marquee className='marquee' direction="left" >
                        This Year 2023 Our Shop All products <span className='text-warning'>10% Discount</span> & <span className='text-warning'> 30% Cash Back</span>.  Our shop Buy products from.<span className='text-danger'> Our Happy Customar ❤❤</span> .
                    </marquee>
                </div>
                ...
                <div className="ThreeProduct pb-5">
                    <div className="row mx-md-5 mx-2">
                        ...
                        <div className="d-flex justify-content-center mt-5">
                            <Link to={`/cetagory-data/${ProductDetails?.cetagory}`} className="btn btn-primary px-md-5 py-md-3">More Product</Link>
                        </div>
