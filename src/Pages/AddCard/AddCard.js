                                    ...
                                    <div key={product?._id} className="row mx-md-3 card_box mb-2 mx-2 mainrow">
                                        ...
                                        <div className="col-lg-9 col-md-9">
                                            <div className="row">
                                                ...
                                                <div onClick={() => DeleteProduct(product)} className="col-md-1 d-none d-md-block">
                                                    <p className='closeCard'>x</p>
                                                </div>

                                            </div>
                                            <p className='detais'>Details : {product?.Paragrap?.slice(0, 180)} More.. </p>
                        ...
                        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    ...
                                    <div className="card">
                                        <img src={ProductDetails?.image} className="card-img-top p-1" alt="..." />
                                        <div className="card-body">
                                            ...
                                            <p className="card-text text-black pt-2">{ProductDetails?.Paragrap?.slice(0, 200)}</p>
                                ...
                                <div className="modal-footer d-flex justify-content-between">
                                    ...
                                    <Link to={`/payment/${ProductDetails?._idd}`} type="button" className="btn btn-primary" data-bs-dismiss="modal"> <button onClick={() => paymentProduct(ProductDetails)} type="button" className="btn btn-primary">  Get Payment  </button></Link>
                                </div>
                            </div>
                        </div>
                    </div>
