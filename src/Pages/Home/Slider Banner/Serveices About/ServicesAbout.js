            ...
            <section className="servicesAbout">
                <div className="container-fluid justify-content-center about">
                    <div data-aos="fade-down" data-aos-duration="2500">
                        ...
                        <h6 className="text-center Small_Text pb-2">Dictum varius duis at consectetur lorem donec. Nisi lacus sed viverra<br />
                            tellus in hac. Fusce id velit ut tortor pretium viverra.</h6>
                    </div>
                    <div className="row  d-flex justify-content-center">
                        <div data-aos="zoom-in-up" data-aos-duration="1200" className="col-lg-3 md-col-4 col-sm-6 col-12">
                        ...
                        <div className="col-lg-3 md-col-4 col-sm-6 col-12">
                            <div data-aos="zoom-in" data-aos-duration="1600" className="icon-box box">
                        ...
                        <div className="col-lg-3 md-col-4 col-sm-6 col-12">
                            <div data-aos="zoom-in-up" data-aos-duration="1200" className="icon-box box">
